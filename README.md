...
Instalação
Copie a pasta custom_components/fiware para config/custom_components/ na sua instalação do Home Assistant.
Reinicie o Home Assistant.
Vá a Settings → Devices & Services → Add Integration e procure por FIWARE.
Configure api_url, scan_interval e, opcionalmente, stations / exclude pela interface gráfica (UI).
...
Installation
Copy the custom_components/fiware folder into config/custom_components/ in your Home Assistant installation.
Restart Home Assistant.
Go to Settings → Devices & Services → Add Integration and search for FIWARE.
Configure api_url, scan_interval, and optionally stations / exclude through the graphical UI.
